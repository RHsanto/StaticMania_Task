      ...
      <div className="grid lg:grid-cols-3 justify-center gap-5 ">
        <div className="bg-off-white overflow-hidden m-10 lg:m-0">
          <div className="art-con p-10 ">
            ...
            <p className="text-primary mt-4 hover:text-sub-primary cursor-pointer"> See more</p>
          </div>
        ...
        {allArticle?.map(data => (
          <div key={data?.id} className="card mb-10 px-10 lg:px-0">
            ...
            <div className="card-content ">
              ...
              <p className="text-primary mt-4 hover:text-sub-primary cursor-pointer"> Read Now</p>
            </div>
          </div>
        ))}
      </div>
